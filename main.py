...
for bay in ["Salluit","DeceptionBay","Kangiqsujuaq"]:
    ...
    for i, image_folder in enumerate(image_folders):
        ...
        image_path = os.path.join(image_dir, image_folder, image_folder+"_sub_cal_C3_spk_HAa_TC_reproj.tif")
        ...
        if "Ratio" in band_index[1]:
            ...
            tiffstats.compute_statistics(AOI_paths, results_dir, band_index, no_data_value, convert_to_dB=1, overwrite=1)
